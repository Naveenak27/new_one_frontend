...
// import React, { useEffect, useState } from 'react';
// import { Card, Table, Tag, Button, Space, DatePicker, Input, message, Drawer, Row, Col, Divider, Typography } from 'antd';
// import { ReloadOutlined, SearchOutlined, EyeOutlined, ClockCircleOutlined } from '@ant-design/icons';
// import api from '../services/api';
...
//                   </Text>
//                   <Text style={{ fontSize: '14px' }}>
//                     {new Date(selectedLeave.approved_date).toLocaleDateString('en-GB', {
//                       day: '2-digit',
//                       month: 'short',
//                       year: 'numeric'
//                     })}
...
//                   </Text>
//                   <Text style={{ fontSize: '14px' }}>
//                     {new Date(selectedLeave.rejected_date).toLocaleDateString('en-GB', {
//                       day: '2-digit',
//                       month: 'short',
//                       year: 'numeric'
//                     })}
...
//   rejected: 'red',
//   cancelled: 'default',
//   on_hold: 'gold'  // Added on_hold status
// };
...
//         leave.approver_name?.toLowerCase().includes(value.toLowerCase()) ||
//         leave.rejector_name?.toLowerCase().includes(value.toLowerCase()) ||
//         leave.holder_name?.toLowerCase().includes(value.toLowerCase())  // Added holder search
//       );
//     });
//     setFilteredData(filtered);
//   };
...
//       render: (status) => getStatusTag(status),
//       filters: Object.keys(statusColors).map(s => ({ 
//         text: s === 'on_hold' ? 'On Hold' : s.charAt(0).toUpperCase() + s.slice(1), 
//         value: s 
//       })),
//       onFilter: (value, record) => record.status === value
//     },
...
//               {/* Added Hold By Information */}
//               {selectedLeave.status === 'on_hold' && selectedLeave.holder_name && (
//                 <Col span={12}>
//                   <Text type="secondary" style={{ fontSize: '12px', display: 'block', marginBottom: '6px' }}>
//                     Put On Hold By
//                   </Text>
//                   <Text style={{ fontSize: '14px' }}>
//                     {selectedLeave.holder_name}
//                   </Text>
//                 </Col>
//               )}
...
//                   </Text>
//                   <Text style={{ fontSize: '14px' }}>
//                     {new Date(selectedLeave.approved_at).toLocaleDateString('en-GB', {
//                       day: '2-digit',
//                       month: 'short',
//                       year: 'numeric'
//                     })}
...
//                   </Text>
//                   <Text style={{ fontSize: '14px' }}>
//                     {new Date(selectedLeave.rejected_at).toLocaleDateString('en-GB', {
//                       day: '2-digit',
//                       month: 'short',
//                       year: 'numeric'
//                     })}
...
//               {/* Added Hold Date */}
//               {selectedLeave.hold_at && (
//                 <Col span={12}>
//                   <Text type="secondary" style={{ fontSize: '12px', display: 'block', marginBottom: '6px' }}>
//                     Hold Date
//                   </Text>
//                   <Text style={{ fontSize: '14px' }}>
//                     {new Date(selectedLeave.hold_at).toLocaleDateString('en-GB', {
//                       day: '2-digit',
//                       month: 'short',
//                       year: 'numeric'
//                     })}
...
import React, { useEffect, useState } from 'react';
import { Card, Table, Tag, Button, Space, DatePicker, Input, message, Drawer, Row, Col, Divider, Typography, Dropdown, Modal, Menu } from 'antd';
import { ReloadOutlined, SearchOutlined, EyeOutlined, ClockCircleOutlined, CheckOutlined, CloseOutlined, PauseOutlined, MoreOutlined } from '@ant-design/icons';
import api from '../services/api';
  ...
  const handleSearch = (value) => {
    const filtered = leaves.filter((leave) => {
      return (
        ...
        leave.approver_name?.toLowerCase().includes(value.toLowerCase()) ||
        leave.rejector_name?.toLowerCase().includes(value.toLowerCase()) ||
        leave.holder_name?.toLowerCase().includes(value.toLowerCase())
      );
    });
    setFilteredData(filtered);
  };
          ...
          <div style={{ marginBottom: 16 }}>
            <Space direction="vertical" size="small" style={{ width: '100%' }}>
              ...
              <p style={{ margin: 0 }}>
                ...
                {selectedRecord.leave_code === 'OD' && ' (On Duty)'}
              </p>
            ...
            {selectedLeave.hold_reason && (
              <>
                ...
                <div style={{
                  ...
                  <Text strong style={{ fontSize: '12px', display: 'block', marginBottom: '8px', color: '#d46b08' }}>
                    Hold Reason
                  </Text>
                  <Text style={{ fontSize: '14px' }}>
                    {selectedLeave.hold_reason}
            ...
            {selectedLeave.approver_comments && (
              <>
                ...
                <div style={{ 
                  ...
                  <Text strong style={{ fontSize: '12px', display: 'block', marginBottom: '8px', color: '#389e0d' }}>
                    Approval Comments
                  </Text>
                  <Text style={{ fontSize: '14px' }}>
                    {selectedLeave.approver_comments}
            ...
            {selectedLeave.rejection_reason && (
              <>
                ...
                <div style={{ 
                  ...
                  <Text strong style={{ fontSize: '12px', display: 'block', marginBottom: '8px', color: '#cf1322' }}>
                    Rejection Reason
                  </Text>
                  <Text style={{ fontSize: '14px' }}>
                    {selectedLeave.rejection_reason}
